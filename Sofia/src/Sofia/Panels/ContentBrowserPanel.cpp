...
namespace Sofia {
	...
	ContentBrowserPanel::ContentBrowserPanel()
		: m_CurrDir(g_AssetsPath)
	{
		Texture2DProps props;
		props.Filepath = g_AssetsPath / L"textures/DirectoryIcon.png";
		props.Sampling = TextureSampling::Point;
		m_DirIcon = Texture2D::Create(props);
		props.Filepath = g_AssetsPath / L"textures/FileIcon.png";
	...
	void ContentBrowserPanel::OnUIRender()
	{
		...
		for (auto& dir : std::filesystem::directory_iterator(m_CurrDir))
		{
