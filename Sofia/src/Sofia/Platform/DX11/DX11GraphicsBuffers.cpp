	...
	void DX11ConstantBuffer::Bind() const
	{
		...
		Renderer::Submit([instance]()
		{
			if (instance->m_Binding == BufferShaderBinding::Vertex)
				DX11Context::GetContextFromApplication()->GetContext()->VSSetConstantBuffers(0u, 1u, instance->m_Buffer.GetAddressOf());
			else if (instance->m_Binding == BufferShaderBinding::Fragment)
				DX11Context::GetContextFromApplication()->GetContext()->PSSetConstantBuffers(0u, 1u, instance->m_Buffer.GetAddressOf());
		});
	}
}
