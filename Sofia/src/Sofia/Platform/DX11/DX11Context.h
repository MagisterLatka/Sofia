...
namespace Sofia {
	...
	public:
		...
		ComPtr<ID3D11Device5> GetDevice()		{ SOF_CORE_ASSERT(m_Device,  "No DX11Device created"); return m_Device; }
		ComPtr<ID3D11DeviceContext4> GetContext(){ SOF_CORE_ASSERT(m_Context, "No DX11Device created"); return m_Context; }
