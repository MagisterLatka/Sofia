...
namespace Sofia {
	...
	static DXGI_FORMAT GetFormat(RenderTargetFormat format)
	{
		...
		case Sofia::RenderTargetFormat::R32_UINT:			return DXGI_FORMAT_R32_UINT;
		...
		case Sofia::RenderTargetFormat::RG32F:				return DXGI_FORMAT_R32G32_FLOAT;
		case Sofia::RenderTargetFormat::RG32_UINT:			return DXGI_FORMAT_R32G32_UINT;
		...
		case Sofia::RenderTargetFormat::RGB32_UINT:			return DXGI_FORMAT_R32G32B32_UINT;
		...
		case Sofia::RenderTargetFormat::RGBA32_UINT:		return DXGI_FORMAT_R32G32B32A32_UINT;
		case Sofia::RenderTargetFormat::Depth32F:			return DXGI_FORMAT_D32_FLOAT;
		case Sofia::RenderTargetFormat::Depth24Stencil8:	return DXGI_FORMAT_D24_UNORM_S8_UINT;
		}
	...
	static uint32_t GetBPP(RenderTargetFormat format)
	{
		...
		case Sofia::RenderTargetFormat::R32_UINT:
		case Sofia::RenderTargetFormat::RG16F:
		case Sofia::RenderTargetFormat::RGBA8:
		case Sofia::RenderTargetFormat::Depth32F:
		case Sofia::RenderTargetFormat::Depth24Stencil8:
			return 4;
		case Sofia::RenderTargetFormat::RG32F:
		case Sofia::RenderTargetFormat::RG32_UINT:
		case Sofia::RenderTargetFormat::RGBA16F:
			return 8;
		case Sofia::RenderTargetFormat::RGB32F:
		case Sofia::RenderTargetFormat::RGB32_UINT:
			return 12;
		case Sofia::RenderTargetFormat::RGBA32F:
		case Sofia::RenderTargetFormat::RGBA32_UINT:
			return 16;
		}
		SOF_CORE_THROW_INFO("Unknown render target format");
		return 0;
