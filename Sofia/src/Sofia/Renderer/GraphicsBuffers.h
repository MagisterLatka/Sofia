...
namespace Sofia {
	...
	public:
		...
		virtual void SetData(void* data, uint32_t size, uint32_t offset = 0u) = 0;
		...
		static Ref<VertexBuffer> Create(const BufferLayout& layout, void* data, uint32_t size, BufferUsage usage = BufferUsage::Default);
		static Ref<VertexBuffer> Create(const BufferLayout& layout, const Buffer& buffer, BufferUsage usage = BufferUsage::Default);
		static Ref<VertexBuffer> Create(const BufferLayout& layout, Buffer&& buffer, BufferUsage usage = BufferUsage::Default);
	};
	...
	public:
		...
		virtual void SetData(uint32_t* data, uint32_t size, uint32_t offset = 0u) = 0;
		virtual void SetData(const Buffer& buffer, uint32_t offset = 0u) = 0;
		virtual void SetData(Buffer&& buffer, uint32_t offset = 0u) = 0;
		...
		static Ref<IndexBuffer> Create(uint32_t* data, uint32_t size, BufferUsage usage = BufferUsage::Default);
		static Ref<IndexBuffer> Create(const Buffer& buffer, BufferUsage usage = BufferUsage::Default);
		static Ref<IndexBuffer> Create(Buffer&& buffer, BufferUsage usage = BufferUsage::Default);
	};
	...
	public:
		...
		static Ref<ConstantBuffer> Create(BufferShaderBinding binding, void* data, uint32_t size);
		static Ref<ConstantBuffer> Create(BufferShaderBinding binding, const Buffer& buffer);
		static Ref<ConstantBuffer> Create(BufferShaderBinding binding, Buffer&& buffer);
		static Ref<ConstantBuffer> Create(BufferShaderBinding binding, const UniformBufferBase& buffer);
	};
}
